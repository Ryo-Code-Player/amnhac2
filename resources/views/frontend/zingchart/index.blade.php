...
<div class="zc-container">
    <div class="zc-chartjs-container">
        <div class="zc-chartjs-title">Thông kê danh sách bài hát đứng đầu bảng xếp hạng</div>
        <canvas id="zingLineChart" height="150"></canvas>
    </div>
            ...
            @foreach($song as $key => $s)
                ...
                <tr>
                    <td style="display:flex;align-items:center;">
                        ...
                        <img class="zc-song-img" src="{{ asset($s->singer->photo) }}" alt="" />
                    </td>
                    ...
                    <td>
                        ...
                        '{{ $s->title }}', '{{ $s->singer->alias }}','{{ $s->singer->photo }}',{{ $s->id }})">
                        ...
                        <button style="background:none;border:none;cursor:pointer;padding:0;margin-right:8px;" onclick="openAddPlaylistPopup('{{ $s->id }}', '{{ $s->title }}', '{{ $s->singer->photo }}')">
