...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('admin.user.create')}}" class="btn btn-primary shadow-md mr-2">Thêm người dùng</a>
        ...
        <div   class=" intro-y col-span-12 flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form action="{{route('admin.user.sort')}}" method = "get" class="xl:flex sm:mr-auto" >
