        ...
        <div class="intro-y col-span-12 lg:col-span-12">
            ...
            <form method="post" action="{{route('admin.group.store')}}">
                ...
                <div class="intro-y box p-5">
                    <div class="mt-3">
                        <label for="regular-form-1" class="form-label">Tên nhóm</label>
                        <input id="title" name="title" type="text" class="form-control" placeholder="Tên nhóm">
                    ...
                    <div class="mt-3">
                        <div class="flex flex-col sm:flex-row items-center">
                            <label style="min-width:70px  " class="form-select-label" for="status">Loại nhóm</label><br/>
