...
<h2 class="intro-y text-lg font-medium mt-10">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('admin.roleuser.create')}}" class="btn btn-primary shadow-md mr-2">Thêm quyền</a>
            
            <div class="hidden md:block mx-auto text-slate-500">Hiển thị trang {{$role_user->currentPage()}} trong {{$role_user->lastPage()}} trang</div>
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        <td>
                            <a target="_blank" href="" class="font-medium whitespace-nowrap">{{$item->alias}}</a> 
                        </td>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="{{route('admin.roleuser.edit',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                <form action="{{route('admin.roleuser.destroy',$item->id)}}" method = "post">
                                    @csrf
                                    @method('delete')
    ...
    <!-- END: HTML Table Data -->
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
            <nav class="w-full sm:w-auto sm:mr-auto">
                {{$role_user->links('vendor.pagination.tailwind')}}
            </nav>
