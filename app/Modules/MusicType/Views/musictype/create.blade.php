...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Thêm Thể Loại Âm Nhạc</h2>
</div>
<div class="grid grid-cols-12 gap-12 mt-5">
    <div class="intro-y col-span-12 lg:col-span-12">
        <form method="post" action="{{ route('admin.musictype.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="intro-y box p-5">
                <div>
                    <label for="title" class="form-label">Tên Thể Loại</label>
                    <input id="title" name="title" type="text" class="form-control" placeholder="Tên Thể Loại" value="{{ old('title') }}" required>
                </div>
