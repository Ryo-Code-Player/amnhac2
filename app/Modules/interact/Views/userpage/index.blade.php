...
@include('backend.layouts.notification')
    <h2 class="intro-y text-lg font-medium mt-10">
        Danh sách trang người dùng
    </h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('admin.userpage.create')}}" class="btn btn-primary shadow-md mr-2">Thêm trang người dùng</a>
                    ...
                    <td class="table-report__action w-56">
                            ...
                            <div class="dropdown py-3 px-1 ">  
                                ...
                                <div class="dropdown-menu w-40"> 
                                    ...
                                    <li><a class="dropdown-item" href="{{route('admin.userpage.edit',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a></li>
                                    <li>
                                        <form action="{{route('admin.userpage.destroy',$item->id)}}" method = "post">
                                            @csrf
                                            @method('delete')
    ...
    <!-- END: HTML Table Data -->
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
            <nav class="w-full sm:w-auto sm:mr-auto">
                {{$userpage->links('vendor.pagination.tailwind')}}
            </nav>
